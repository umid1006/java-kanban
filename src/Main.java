...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task2 = new Task("model.Task #2", "Task2 description", "NEW");
        ...
        Subtask subtask1 = new Subtask("model.Subtask #1-1", "Subtask1 description", "NEW", epic1.getId());
        Subtask subtask2 = new Subtask("model.Subtask #2-1", "Subtask1 description", "NEW", epic1.getId());
        Subtask subtask3 = new Subtask("model.Subtask #3-2", "Subtask1 description", "NEW", epic1.getId());
